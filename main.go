...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	avgSpeedInMs := w.meanSpeed() * 1000 / 3600
	return ((CaloriesWeightMultiplier * w.Weight) + ((math.Pow(avgSpeedInMs, 2) / w.Height) * CaloriesSpeedHeightMultiplier * w.Weight)) * float64(w.Duration.Hours()) * MinInHours
}
